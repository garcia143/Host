...
<html lang="{{currentLang}}">
  <head>
    ...
    {{stylesheetLink("theme/css/workplace.css")}}
  </head>
  <body class="fixed-nav sticky-footer bg-dark">
  	...
  	<nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top" id="mainNav">
          ...
          <!-- Employees -->
              ...
              <li>
  						...
  						<li>
  							<a href="{{url("workplace/employees/job")}}">{{translate._("WORKPLACE@MENU_EMPLOYEESJOB")}}</a>
  						</li>
              <li>
          ...
          <!-- Tools -->
  				<li class="nav-item" data-toggle="tooltip" data-placement="right" title="Components">
  					<a class="nav-link nav-link-collapse collapsed" data-toggle="collapse" href="#tools" data-parent="#exampleAccordion">
  						<i class="fa fa-fw fa-wrench"></i>
  						<span class="nav-link-text">{{translate._('WORKPLACE@MENU_TOOLS')}}</span>
  					</a>
    ...
    {{javascriptInclude("theme/js/workplace.js")}}
  </body>
</html>
